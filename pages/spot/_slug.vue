<template>
	<section class="spot">
		<header class="spot-header">
			...
			<nuxt-link to="/" class="spot-close btn">
		...
		<footer class="spot-complementary">
			...
			<div class="spot-infos">
				<div class="spot-date">{{ this.$store.state.lang.spot.infos.created }}
					<time>{{ spot.createdAt | moment('DD-MM-YYYY') }}</time>
				</div>
				<div class="spot-date" v-if="spot.updatedAt !== spot.createdAt">{{ this.$store.state.lang.spot.infos.edited }}
		...
		removeSpot () {
			this.$modal.show('dialog', {
				...
				buttons: [
					...
					{
						title: this.$store.state.lang.modal.spot.remove.action.buttons.confirm,
						handler: () => {
